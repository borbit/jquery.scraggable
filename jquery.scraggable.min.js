...
this.bounds=this.getBounds()};c.prototype.enableWheelHandling=function(){this.parent.get(0).addEventListener&&(this.parent.get(0).addEventListener("mousewheel",this.onmousewhell,!1),this.parent.get(0).addEventListener("DOMMouseScroll",this.onmousewhell,!1))};c.prototype.disableWheelHandling=function(){this.parent.get(0).removeEventListener&&(this.parent.get(0).removeEventListener("mousewheel",this.onmousewhell,!1),this.parent.get(0).removeEventListener("DOMMouseScroll",this.onmousewhell,!1))};c.prototype.processMouseWhell=
